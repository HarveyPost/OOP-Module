 ...
 *
 * @author Nick Efford & Harvey Postings
 */
public class Point {
  ...
  public Point(ZonedDateTime inputTime, double inputLongitude,
      double inputLatitude, double inputElevation) {
    if (inputLongitude < MIN_LONGITUDE || inputLongitude > MAX_LONGITUDE
        || inputLatitude < MIN_LATITUDE || inputLatitude > MAX_LATITUDE) {
